        ...
        <>
            <div id="menuBar" className="responsiveWidth menuBar">
                <div className="menuButtons" id="accessButton">
                    <a href={Pages.access.path}><img className="menuImages" src={`${process.env.PUBLIC_URL}/img/menuBarIcon/astronaut.png`} /></a>
                    <p className="menuTexts">{Pages.access.displayName}</p>
                </div>

                <div className="menuButtons" id="eventButton">
                    <a href={Pages.event.path}><img className="menuImages" src={`${process.env.PUBLIC_URL}/img/menuBarIcon/astronaut.png`} /></a>
                    <p className="menuTexts">{Pages.event.displayName}</p>
                </div>

                <div className="menuButtons" id="homeButton">
                    <a href={Pages.home.path}><img className="menuImages" src={`${process.env.PUBLIC_URL}/img/menuBarIcon/astronaut.png`} /></a>
                    <p className="menuTexts">{Pages.home.displayName}</p>
                </div>

                <div className="menuButtons" id="mapButton">
                    <a href={Pages.map.path}><img className="menuImages" src={`${process.env.PUBLIC_URL}/img/menuBarIcon/astronaut.png`} /></a>
                    <p className="menuTexts">{Pages.map.displayName}</p>
                </div>

                <div className="menuButtons" id="projectButton">
                    <a href={Pages.project.path}><img className="menuImages" src={`${process.env.PUBLIC_URL}/img/menuBarIcon/astronaut.png`} /></a>
